            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-12">
                    {genres?.map((genre: { id: number, name: string }, index: number) => (
                        <a href={`/genres/${genre.id}?page=1`} key={index} className='flex flex-col items-center gap-2 bg-white/5 rounded-xl p-4 hover:scale-105 transform transition-all duration-300'>
