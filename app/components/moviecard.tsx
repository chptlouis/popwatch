export default function MovieCard(movie: any) {
    return (
        <div className="relative transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-60 opacity-100 lg:opacity-0 hover:opacity-100 transition-opacity duration-200 flex flex-col justify-end items-start p-4 rounded-lg">
